/*
  # Investment Platform Schema V2.4

  1. Core Tables
    - investments: Main investment tracking table
    - analytics_metrics: Advanced analytics and metrics
    - user_preferences: Enhanced user settings and preferences
    - notifications: Real-time notification system
    - performance_metrics: Investment performance tracking
    - user_connections: Social networking features
