...
ALTER TABLE investments ADD COLUMN IF NOT EXISTS performance_score decimal;
ALTER TABLE investments ADD COLUMN IF NOT EXISTS risk_indicators jsonb;
ALTER TABLE investments ADD COLUMN IF NOT EXISTS social_metrics jsonb;
